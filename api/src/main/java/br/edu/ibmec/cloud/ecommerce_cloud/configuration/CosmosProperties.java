...
public class CosmosProperties {
    ...
    public boolean isResponseDiagnosticsEnabled() { return responseDiagnosticsEnabled; }
    public void setResponseDiagnosticsEnabled(boolean responseDiagnosticsEnabled) { this.responseDiagnosticsEnabled = responseDiagnosticsEnabled; }
}